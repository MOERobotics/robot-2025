...
public class AlgaeCollectorSim {
    ...
    SparkMaxSim algaeWheelSim, algaeArmSim;
    SparkLimitSwitchSim algaeWheelLimitSim;
    CANcoderSimState algaeArmEncoderSim;
    SingleJointedArmSim algaeArmSystem = new SingleJointedArmSim(DCMotor.getNEO(1), armGearing, 0.1, Units.inchesToMeters(16), 0, Math.PI/2, true, Math.PI/2);
    DCMotorSim algaeWheelSystem = new DCMotorSim(LinearSystemId.createDCMotorSystem(DCMotor.getNEO(1), 0.01, wheelGearing), DCMotor.getNEO(1));
