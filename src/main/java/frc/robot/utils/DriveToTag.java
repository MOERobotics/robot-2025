...
public class DriveToTag {
    ...
    public static Pose2d moveToRight(Pose2d currentPose) {
        return getClosestTarget(currentPose, new Transform2d(Inches.of(15), Inches.of(15.75), Rotation2d.k180deg));
    }
    public static Pose2d moveToLeft(Pose2d currentPose) {
        return getClosestTarget(currentPose, new Transform2d(Inches.of(15), Inches.of(2), Rotation2d.k180deg));
    }
