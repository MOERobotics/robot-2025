...
public class ReefToSourceL1 {
    ...
    public static Autos.CommandAndPose S1_C4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start1 C", "C Coral Station");
    }
    public static Autos.CommandAndPose S1_B4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start1 B", "B Coral Station 2");
    }
    public static Autos.CommandAndPose S1_A4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start1 A", "A Coral Station 2");
    }
    // START 2 AUTOS
    public static Autos.CommandAndPose S2_E4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start2 E", "E Coral Station");
    }


    public static Autos.CommandAndPose S2_F4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start2 F", "F Coral Station");
    }
    public static Autos.CommandAndPose S2_C4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start2 C", "C Coral Station");
    }
    public static Autos.CommandAndPose S2_D4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start2 D", "D Coral Station");
    }
    // START 3 AUTOS
    public static Autos.CommandAndPose S3_G2_PRO(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start3 G", "G Processor");
    }
    public static Autos.CommandAndPose S3_H2_PRO(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start3 H", "H Processor");
    }
    // START 4 AUTOS
    public static Autos.CommandAndPose S4_I1_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start4 I", "I Coral Station");
    }
    public static Autos.CommandAndPose S4_J4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start4 J", "J Coral Station");
    }
    public static Autos.CommandAndPose S4_K4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start4 K", "K Coral Station");
    }
    public static Autos.CommandAndPose S4_L4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start4 L", "L Coral Station");
    }
    // START 5 AUTOS
    public static Autos.CommandAndPose S5_L4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start5 L", "L Coral Station");
    }
    public static Autos.CommandAndPose S5_B4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start5 B", "B Coral Station 1");
    }
    public static Autos.CommandAndPose S5_A4_CS(RobotContainer robot) {
        return buildReefToSourceL1Command(robot, "Start5 A", "A Coral Station 1");
    }



    @SneakyThrows
    public static Autos.CommandAndPose buildReefToSourceL1Command(
